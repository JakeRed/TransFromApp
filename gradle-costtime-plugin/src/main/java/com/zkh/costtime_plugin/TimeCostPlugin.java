...
public class TimeCostPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        try {
            ...
            //project获取android gradle plugin中的名为android的扩展实例
            AppExtension appExtension = (AppExtension) project.getExtensions().getByName("android");
            //调用android的扩展实例注册我们自定义的Transform
            appExtension.registerTransform(new com.zkh.costtime_plugin.TimeCostTransform());
